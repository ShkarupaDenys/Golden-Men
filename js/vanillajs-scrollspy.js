  ...
  _createClass(VanillaScrollspy, [{
    ...
    value: function menuControl() {
      ...
      for (i = 0; i < links.length; i += 1) {
        ...
        if ((refElement.offsetTop - 109) <= scrollPos && (refElement.offsetTop - 109) + refElement.clientHeight > scrollPos) {
    ...
    value: function animated() {
      ...
      function control(e) {
        ...
        if ( document.body.clientWidth <= 1200 ) {
          self.scrollToY(target.offsetTop - 86);
          ...
          self.scrollToY(target.offsetTop - 109);
        }
      };
